                    ...
                    <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700 overflow-hidden shadow-2xl sm:rounded-2xl p-8">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300">Tipo de Producto</label>
                                    <select
                                        value={data.type}
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-1">
                                        ...
                                        <input
                                            ...
                                            className="block w-full pl-7 rounded-md border-gray-600 bg-gray-700 text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                                            required
                                        />
                                    </div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-300">Stock Inicial</label>
                                <input
                                    type="number"
                                    value={data.stock}
